...
def test_max_places_limit(mocked_client, mocked_clubs_data, mocked_competitions_data):
...
def test_competition_full(mocked_client, mocked_clubs_data, mocked_competitions_data):
...
def test_not_enough_places(mocked_client, mocked_clubs_data, mocked_competitions_data):
