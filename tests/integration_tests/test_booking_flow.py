def test_booking_flow_complete(
    ...
    # Update club points in mock data
    club['points'] = str(expected_remaining_points)
    ...
    # Update competition places in mock data
    competition['numberOfPlaces'] = str(expected_remaining_places)
    ...
    # Expected 127 points after booking
    assert int(updated_club['points']) == expected_remaining_points
    # Expected 19 places remaining
    assert int(updated_competition['numberOfPlaces']
